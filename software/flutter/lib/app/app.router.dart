...
class FeedbackViewArguments {
  const FeedbackViewArguments({required this.connectedDeviceName});

  final String connectedDeviceName;

  @override
  String toString() {
    return '{"connectedDeviceName": "$connectedDeviceName"}';
  }

  @override
  bool operator ==(covariant FeedbackViewArguments other) {
    if (identical(this, other)) return true;
    return other.connectedDeviceName == connectedDeviceName;
  }

  @override
  int get hashCode {
    return connectedDeviceName.hashCode;
  }
}
